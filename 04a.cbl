...
procedure division.
  ...
  *> move 6 to rf_line_cnt
  ...
  perform varying rf_line_idx from 1 by 1 until rf_line_idx > rf_line_cnt
    ...
    *> display "LEFT: " left_from " to " left_to " === RIGHT: " right_from " to " right_to

    if (left_from >= right_from and left_to <= right_to) or (right_from >= left_from and right_to <= left_to)
      *> display "FOUND"
