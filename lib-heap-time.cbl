...
program-id. lib-heap-time is initial.
...
data division.
  local-storage section.
    ...
    01 swap-temp.
      ...
      02 swap_temp_val.
        03 swap_temp_y pic s9(3) comp.
        03 swap_temp_x pic s9(3) comp.
        03 swap_temp_t pic s9(3) comp.
  ...
  linkage section.
    01 ln-heap_stuff.
      ...
      02 ln-oper pic x(6).
      02 ln-heap_new_item.
        03 ln-heap_new_key pic s9(8) comp.
        03 ln-heap_new_val.
          04 ln-heap_new_y pic s9(3) comp.
          04 ln-heap_new_x pic s9(3) comp.
          04 ln-heap_new_t pic s9(3) comp.
      02 ln-in_heap.
        03 ln-heap_cnt pic s9(8) comp value 0.
        03 ln-heap_item occurs 1 to unbounded
            depending on ln-heap_cnt indexed by ln-heap_idx.
          04 ln-heap_item_key pic s9(8) comp.
          04 ln-heap_item_val.
            05 ln-heap_item_y pic s9(3) comp.
            05 ln-heap_item_x pic s9(3) comp.
            05 ln-heap_item_t pic s9(3) comp.


procedure division using ln-heap_stuff.
...
search_heap.
  ...
  search ln-heap_item
    ...
    *> when ln-heap_item_y(ln-heap_idx) = ln-heap_new_y
    *>     and ln-heap_item_x(ln-heap_idx) = ln-heap_new_x
    *>     and ln-heap_item_t(ln-heap_idx) = ln-heap_new_t
      move ln-heap_item_key(ln-heap_idx) to ln-heap_new_key
  end-search
  *> *> This below, is slower.
  *> move 0 to ln-heap_new_key
  *> perform varying ln-heap_idx from 1 by 1 until ln-heap_idx > ln-heap_cnt
  *>   if ln-heap_item_val(ln-heap_idx) = ln-heap_new_val
  *>     move ln-heap_item_key(ln-heap_idx) to ln-heap_new_key
  *>   end-if
  *> end-perform
  .
