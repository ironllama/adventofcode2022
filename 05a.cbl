    ...
    *> For lib-readfile
    ...
    01 dock.
      ...
      02 dock_row occurs 9 times indexed by dock_idx.
        03 crate_stack_cnt pic s9(8) comp value 0.
        03 crate_stack_row pic x(99).
  ...
  perform varying rf_line_idx from 1 by 1 until rf_line_idx > rf_line_cnt
    ...
    *> Then parse all the moves.
      ...
      *> display "amt " move_amt " from " move_from " to " move_to
      ...
      perform varying crane_idx from 1 by 1 until crane_idx > move_amt
        move crate_stack_row(move_from)(1:1) to crane

        move crate_stack_row(move_from)(2:) to crate_stack_row(move_from)
        subtract 1 from crate_stack_cnt(move_from)
