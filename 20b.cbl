...
data division.
  working-storage section.
    *> For lib-readfile
    ...
    01 all_start_nums.
      02 start_num_cnt pic s9(8) comp value 0.
      02 start_num_row occurs 5001 times indexed by start_num_idx.
        03 start_num pic s9(18) comp.
        03 start_num_orig_idx usage is index.
    ...
    77 encypt_key pic 9(9) comp.
    77 loop_num usage is index.

procedure division.
  call 'lib-readdata' using function module-id ".dat" rf_all_lines
*>   call 'lib-readdata' using function module-id ".da1" rf_all_lines

  move 811589153 to encypt_key
  ...
  perform varying rf_idx from 1 by 1 until rf_idx > rf_cnt
    ...
    *> end-perform
    ...
    compute num(num_cnt) = num(num_cnt) * encypt_key
    move rf_idx to num_orig_idx(num_cnt)
  end-perform

  move all_nums to all_start_nums
  ...
  *> display "]"
  ...
  perform varying loop_num from 1 by 1 until loop_num > 10
    perform varying start_num_idx from 1 by 1 until start_num_idx > start_num_cnt
      *> display "CURR NUM: " function trim(start_num_row(start_num_idx))
      move start_num_row(start_num_idx) to current
