      ...
      if result = "Z"
        ...
        search winning_combos
          when win_their_move(winning_combos_idx) = their_move
            move win_your_move(winning_combos_idx) to your_move
            compute total_points = total_points + 6
        end-search
      else
        set winning_combos_idx to 1
        search winning_combos
          when win_your_move(winning_combos_idx) = their_move
            move win_their_move(winning_combos_idx) to your_move
        end-search
      end-if
    end-if
